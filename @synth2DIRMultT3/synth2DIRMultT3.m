classdef synth2DIRMultT3<handle
    ...
    methods
        function obj = synth2DIRMultT3(interferometer_scan,wavenumber,anharmonicity,tauc1,del1,wait)%,cross_peak_weight)
            %%
...
%             gf=@(t,tauc1,del1) del1(1).^2*tauc1(1).^2* (exp(-t/ tauc1(1)))+...%slow
%                 del1(2).^2*tauc1(2).^2* (exp(-t/ tauc1(2)));%fast
